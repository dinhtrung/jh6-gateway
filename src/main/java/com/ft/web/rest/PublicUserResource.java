...
public class PublicUserResource {
     ...
     */
    @GetMapping("/users")
    public ResponseEntity<List<PublicUserDTO>> getAllUsers(@QuerydslPredicate(root=User.class) Predicate predicate, Pageable pageable, HttpServletRequest request, @RequestParam(required=false) Map<String, Object> params) {
		if (params != null) {
    	...
    	log.debug("REST request to get a page of user under domain [{}], predicate {}, page {}", domain, predicate, pageable);
        final Page<PublicUserDTO> page = userService.getAllPublicUsers(predicate, pageable, domain);
